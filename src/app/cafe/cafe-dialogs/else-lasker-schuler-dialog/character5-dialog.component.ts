...
export class Character5DialogComponent implements OnInit {
  ...
  constructor(private metaService: Meta, private titleService: Title) {
    this.titleService.setTitle('Else Lasker-Schüler');
    this.metaService.updateTag({ name: 'description', content: 'Else Lasker-Schüler — Oblivion by Robin Hemley' });
    this.metaService.updateTag({ property: 'og:title', content: 'Else Lasker-Schüler — Oblivion by Robin Hemley' });
